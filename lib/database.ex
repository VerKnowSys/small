...
defdatabase Database do
  ...
  deftable History, [:user_id, :content, :timestamp], type: :bag do
    @type t :: %History{user_id: integer, content: String.t, timestamp: String.t}
  ...
  deftable User, [{ :id, autoincrement }, :name], type: :set, index: [:name] do
    ...
    def add_history self, content do
      %History{user_id: self.id, content: content, timestamp: Timestamp.now} |> History.write
    end
